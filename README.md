...
## Candidate Comments
- I used Factory pattern here however we can use a strategy pattern as well.
- I choose a refelction to initilise the Factorymethod so we adding roles in future can be done in only one place.
